from scripts.cost_sheet.refs import current_sha, permalink, registry_entry_line
...
def test_permalink_shape():
    ...
    assert (
        url
        == "https://github.com/AIcrowd/flopscope/blob/abc123/src/flopscope/_registry.py#L42"
    )
