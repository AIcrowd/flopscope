...
REGISTRY: dict[str, dict] = {
    ...
    "nansum": {
        ...
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Sum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanprod": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 6.0,
        "notes": "Product ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanmax": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Maximum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanmin": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Minimum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanmean": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Mean ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanstd": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.5,
        "notes": "Standard deviation ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanvar": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.5,
        "notes": "Variance ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanargmax": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Index of maximum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nanargmin": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Index of minimum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nancumsum": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Cumulative sum ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "nancumprod": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 6.0,
        "notes": "Cumulative product ignoring NaNs. Same multiply-class structure as cumprod/nanprod, plus numel(input) for the NaN test pass.",
    },
    "median": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanmedian": {
        ...
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Median ignoring NaNs, plus numel(input) for the NaN test pass.",
    },
    "percentile": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanpercentile": {
        ...
        "module": "numpy",
        "complex_factor": "illegal",
        "notes": "q-th percentile ignoring NaNs. Same piecewise unweighted/weighted per-output cost as percentile (n = axis_dim, k = q.size; see _quantile_dense_cost), plus numel(input) for the NaN test pass. Complex-illegal: numpy explicitly rejects complex input, same as percentile.",
    },
    "quantile": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanquantile": {
        ...
        "module": "numpy",
        "complex_factor": "illegal",
        "notes": "q-th quantile ignoring NaNs. Same piecewise unweighted/weighted per-output cost as percentile (n = axis_dim, k = q.size; see _quantile_dense_cost), plus numel(input) for the NaN test pass. Complex-illegal: numpy explicitly rejects complex input, same as percentile.",
    },
    "ptp": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "linalg.multi_dot": {
        ...
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Chain matmul. Cost: sum of optimal chain matmul_cost steps; each step = 2mkn - mn.",
    },
    "linalg.norm": {
        "category": "counted_custom",
        "module": "numpy.linalg",
