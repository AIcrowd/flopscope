...
REGISTRY: dict[str, dict] = {
    ...
    "nansum": {
        ...
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Sum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanprod": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 6.0,
        "notes": "Product ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanmax": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Maximum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanmin": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Minimum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanmean": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Mean ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanstd": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.5,
        "notes": "Standard deviation ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanvar": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.5,
        "notes": "Variance ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanargmax": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Index of maximum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nanargmin": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Index of minimum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nancumsum": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Cumulative sum ignoring NaNs. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "nancumprod": {
        "category": "counted_reduction",
        "module": "numpy",
        "complex_factor": 6.0,
        "notes": "Cumulative product ignoring NaNs. Same multiply-class structure as cumprod/nanprod. plus numel(input) for the NaN test pass on INEXACT (float/complex) input only, orbit-mapped like every other pass: numpy's _replace_nan runs no NaN test at all for integer or bool input, which therefore bills exactly like the plain sibling.",
    },
    "median": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanmedian": {
        ...
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Median ignoring NaNs. plus numel(input) for the NaN test pass, orbit-mapped like every other pass and charged for EVERY dtype: this op routes through _remove_nan_1d, which calls np.isnan unconditionally, unlike the factory-built nan* reductions that skip it for integer and bool input.",
    },
    "percentile": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanpercentile": {
        ...
        "module": "numpy",
        "complex_factor": "illegal",
        "notes": "q-th percentile ignoring NaNs. Same piecewise unweighted/weighted per-output cost as percentile (n = axis_dim, k = q.size; see _quantile_dense_cost). plus numel(input) for the NaN test pass, orbit-mapped like every other pass and charged for EVERY dtype: this op routes through _remove_nan_1d, which calls np.isnan unconditionally, unlike the factory-built nan* reductions that skip it for integer and bool input. Complex-illegal: numpy explicitly rejects complex input, same as percentile.",
    },
    "quantile": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "nanquantile": {
        ...
        "module": "numpy",
        "complex_factor": "illegal",
        "notes": "q-th quantile ignoring NaNs. Same piecewise unweighted/weighted per-output cost as percentile (n = axis_dim, k = q.size; see _quantile_dense_cost). plus numel(input) for the NaN test pass, orbit-mapped like every other pass and charged for EVERY dtype: this op routes through _remove_nan_1d, which calls np.isnan unconditionally, unlike the factory-built nan* reductions that skip it for integer and bool input. Complex-illegal: numpy explicitly rejects complex input, same as percentile.",
    },
    "ptp": {
        "category": "counted_reduction",
        "module": "numpy",
    ...
    "linalg.svd": {
        ...
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Singular value decomposition. Cost: $4a^2b+22b^3$ (full U, full_matrices=True and m!=n), $6ab^2+20b^3$ (thin U/V), or $2ab^2+2b^3$ (values-only); a=max(m,n), b=min(m,n). Top-k (1<=k<min(m,n)) bills min(4mnk, economy) (randomized-SVD leading-order cost; see cost-model.md).",
    },
    "linalg.cholesky": {
        "category": "counted_custom",
        "module": "numpy.linalg",
    ...
    "linalg.eig": {
        ...
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Eigendecomposition. Cost: ~$25n^3$.",
    },
    "linalg.eigh": {
        "category": "counted_custom",
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Symmetric eigendecomposition. Cost: ~$9n^3$.",
    },
    "linalg.eigvals": {
        "category": "counted_custom",
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Eigenvalues only. Cost: ~$10n^3$ (DGEEV values-only, 10·N^3).",
    },
    "linalg.eigvalsh": {
        "category": "counted_custom",
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Symmetric eigenvalues. Cost: ~$\\frac{4}{3}n^3$ (tridiagonalization, values only).",
    },
    "linalg.inv": {
        "category": "counted_custom",
        "module": "numpy.linalg",
    ...
    "linalg.multi_dot": {
        ...
        "module": "numpy.linalg",
        "complex_factor": 4.0,
        "notes": "Chain matmul. Cost: sum of optimal chain matmul_cost steps; each step = 2mkn - mn. Exactly two arrays with a 0-d operand instead cost numel(other): numpy delegates that form to dot, which treats a 0-d operand as a scalar multiply with no axis to contract. A 0-d inside a three-or-more-array chain is refused, as numpy refuses it.",
    },
    "linalg.norm": {
        "category": "counted_custom",
        "module": "numpy.linalg",
    ...
    "fft.hfft": {
        ...
        "module": "numpy.fft",
        "complex_factor": 1.0,
        "notes": "FFT of Hermitian-symmetric signal. Cost: 5*(n_out//2)*ceil(log2(n_out)) — numpy implements hfft(a,n) as irfft(conj(a),n) (c2r). Cost formula already counts complex real-FLOPs; priced-in.",
    },
    "fft.ifft": {
        "category": "counted_custom",
        "module": "numpy.fft",
    ...
    "fill_diagonal": {
        ...
        "module": "numpy",
        "complex_factor": 2.0,
        "notes": "Fill main diagonal of given array. Cost: min(m,n), or "
        "ceil(m*n / (n+1)) when wrap=True and the array has more rows than "
        "columns (m>n).",
    },
    "tri": {
        "category": "counted_custom",
    ...
    "roots": {
        ...
        "module": "flopscope._polynomial",
        "complex_factor": 4.0,
        "notes": "Return roots of polynomial with given coefficients. Cost: ~$10n^3$ (companion-matrix eigvals). n = trimmed degree (zero coefficients stripped, as np.roots does).",
    },
    "polyadd": {
        "category": "counted_custom",
        "module": "flopscope._polynomial",
