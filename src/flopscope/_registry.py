...
REGISTRY: dict[str, dict] = {
    ...
    "random.Generator.choice": {
        ...
        "complex_factor": 1.0,
        "module": "numpy.random",
        "cost_formula": "replace=True: numel(output), plus 3*n + numel(output)*ceil(log2(n)) if p given; replace=False: n if p is None else sort_cost(n); n = pool length along the sampled axis (`axis` kwarg, default 0; int a -> a). Canonical (replace=True, p=None): size",
    ...
    "stats.norm.pdf": {
        "category": "counted_custom",
        "cost_formula": "27*max(numel(broadcast(x, distribution params)), 1)",
    ...
    "stats.norm.cdf": {
        "category": "counted_custom",
        "cost_formula": "48*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.norm.ppf": {
        "category": "counted_custom",
        "cost_formula": "83*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.uniform.pdf": {
        "category": "counted_custom",
        "cost_formula": "max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.uniform.cdf": {
        "category": "counted_custom",
        "cost_formula": "4*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.uniform.ppf": {
        "category": "counted_custom",
        "cost_formula": "max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.expon.pdf": {
        "category": "counted_custom",
        "cost_formula": "22*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.expon.ppf": {
        "category": "counted_custom",
        "cost_formula": "27*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.cauchy.pdf": {
        "category": "counted_custom",
        "cost_formula": "6*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.cauchy.cdf": {
        "category": "counted_custom",
        "cost_formula": "20*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.cauchy.ppf": {
        "category": "counted_custom",
        "cost_formula": "28*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.logistic.pdf": {
        "category": "counted_custom",
        "cost_formula": "23*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.logistic.cdf": {
        "category": "counted_custom",
        "cost_formula": "21*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.laplace.cdf": {
        "category": "counted_custom",
        "cost_formula": "40*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.laplace.ppf": {
        "category": "counted_custom",
        "cost_formula": "51*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.lognorm.pdf": {
        "category": "counted_custom",
        "cost_formula": "62*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.lognorm.cdf": {
        "category": "counted_custom",
        "cost_formula": "70*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.lognorm.ppf": {
        "category": "counted_custom",
        "cost_formula": "106*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.truncnorm.pdf": {
        "category": "counted_custom",
        "cost_formula": "28*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.truncnorm.cdf": {
        "category": "counted_custom",
        "cost_formula": "51*max(numel(broadcast(x, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
    ...
    "stats.truncnorm.ppf": {
        "category": "counted_custom",
        "cost_formula": "81*max(numel(broadcast(q, distribution params)), 1)",
        "module": "flopscope.stats",
        "complex_factor": 3.0,
